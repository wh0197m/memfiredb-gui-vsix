export const name = 'memfire-pagination'
...
export const options = {
  ...
  template: `
    <div class="memfire-pagination">
      <icon-btn @click="refresh" iid="refresh" />
      <memfire-input v-model.trim="inputingSize" />
      ...
      <memfire-input v-model.trim="inputingIndex" />
...
export const style = `
  ...
  .memfire-pagination .txt {
    font-size: .8em;
    margin: 0 .2em;
  }
  .memfire-pagination button {
    padding: 0 .28em;
  }
  .memfire-pagination button.big svg {
    transform: scale(1.3);
  }
  .memfire-pagination input {
    width: 2.2em;
    padding: 0 0.16em;
    text-align: center;
  }
