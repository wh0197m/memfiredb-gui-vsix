            ...
            >
              <div>
                ...
                <span class="sort-icons">
                  <memfire-icon iid="arrow-up-filling" :class="{ selected: sortMap[f.name] && sortMap[f.name] == 'desc' }" />
                  <memfire-icon iid="arrow-down-filling" :class="{ selected: sortMap[f.name] && sortMap[f.name] == 'asc' }" />
                </span>
              </div>
            </th>
          </template>
